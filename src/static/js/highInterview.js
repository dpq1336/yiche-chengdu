...
function getPic() {
  ...
  var url = ' https://mapi.yiche.com/web_exhibition/api/v1/common/get_focus_frame?cid=502&ver=6.6.3&uid=' + uid
...
function getList() {
  ...
  var url = 'https://mapi.yiche.com/web_exhibition/api/v1/information/get_information_list?cid=502&ver=6.6.3&uid=' + uid
  var res = getData(url, data)
  console.log(res)
  // var res = {
  //   "status": "1",
  ...
  data.list.map(function (value) {
    value.summary = value.summary.slice(0, 37)
  })
  console.log(data)
  $('.highlist').html(template('highitem', data))
